...
namespace Light
{
	namespace resources
	{
		...
		//vector<Texture*> ResourceManager::m_Textures;
		//vector<ModelCache*> ResourceManager::m_ModelCaches;

#pragma region CheckLoadedResource



		render::Texture * ResourceManager::HasTexture(const string& filename)
		{
		...
		/*ModelCache * ResourceManager::HasModel(const string& filename)
		{
		...
		HeightMap* ResourceManager::HasHeighMap(const string& filename)
		{
			for (size_t i = 0; i < m_HeightMaps.size(); i++)
				if (filename == m_HeightMaps[i]->GetPath()) return m_HeightMaps[i].get();
			return nullptr;
		}
		SpriteAnim * ResourceManager::HasSprite(const string& filename)
		{
		...
		ResourceManager::SoundRAAI * ResourceManager::HasSound(const string & tag)
		{
...
#pragma endregion
		...
		//SpriteAnim * ResourceManager::LoadSpriteAnimation(const string& filename)
		//{
		...
		//{
		//	Cuberender::Texture* tex = nullptr;
		...
		//Texture * ResourceManager::LoadDTX(const string& filename)
		//{
		...
		//byte * ResourceManager::LoadHeightMap(const string& filename, int& w, int& h)
		//{
		...
		//ModelCache * ResourceManager::LoadModel(const string& filename)
		//{
		...
		//	{
		//		pModel = new ModelCache(filename);
		...
		//ModelCache * ResourceManager::LoadModelXML(const string& XMLFile)
		//{
		...
		//IModelResource * ResourceManager::VGetModel(const string& filename)
		//{
