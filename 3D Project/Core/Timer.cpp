...
namespace Light
{
	GameTimer::GameTimer(IContext* c) :m_bStoped(0), m_CurrentTime(0), m_DeltaTime(0), m_PauseTime(0), m_PrevTime(0), m_SecondPerCount(0), m_StartTime(0),
		m_StopTime(0)
	{
	...
	float GameTimer::VGetGameTime() const
	{
	...
	float GameTimer::VGetDeltaTime() const
	{

		return (float)m_DeltaTime;
	}

	void GameTimer::VReset()
	{
		__int64 currentTime;
