...
sol::table EventBinding(sol::this_state s)
{
	...
	//module["EvtCameraCreate"] = events::EvtCameraCreate::StaticType;
	//module["EvtSceneCreate"] = events::EvtSceneCreate::StaticType;
	...
	module.new_usertype<events::EvtKeyEvent>("EvtKeyEvent", "key", &events::EvtKeyEvent::key,"action", &events::EvtKeyEvent::action);
